...
fn window_tab(window_tab_data: Rc<WindowTabData>) -> impl View {
    ...
    let view = stack((
        ...
        crate::ahead::start_work_modal(window_tab_data.clone(), config),
        crate::ahead::presentation_cue_card(window_tab_data.clone(), config),
        crate::ahead::github_auth_modal(window_tab_data.clone(), config),
        crate::ahead::workspace_collab_modal(window_tab_data.clone(), config),
    ))
    .on_cleanup(move || {
