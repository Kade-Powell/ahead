...
The minimal [corrective-debugging](../guide/workflows/corrective-debugging.md) and [operational-stabilization](../guide/workflows/operational-stabilization.md) profiles translate this discussion into pilotable flows. This document retains the reasoning and unresolved questions behind them.
